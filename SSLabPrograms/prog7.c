...
//  
//
//  Created by Arnold Rebello on 28/05/2019.
//
...
void srtf(int n)
{
    ...
    for(i=1;i<=n;i++)
        ...
        printf("%5d%8d%7d%8d%10d%9d%10.0f",process[i].id,process[i].arrival,process[i].burst,process[i].wait,process[i].finish,process[i].turnaround,process[i].ratio);
